...
# Load the dataset
gr = 'data/diff_arch'
data = pd.read_csv(f'./{gr}/train_acc.csv')
...
plt.title('Training accuracy of Student ResNet20', fontsize=fontsize)
...
plt.savefig(f"./{gr}/train_acc.pdf", format="pdf", bbox_inches="tight")
