...
# Load the dataset
gr = 'data/diff_arch'
data = pd.read_csv(f'./{gr}/ce_loss.csv')
...
plt.ylabel('Training CE loss', fontsize=fontsize)
plt.title('Training Cross Entropy Loss of Student ResNet20', fontsize=fontsize)
...
plt.savefig(f"./{gr}/ce_loss.pdf", format="pdf", bbox_inches="tight")
