...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, widen_factor=1, dropout=None):
        ...
        self.linear1 = nn.Linear(int(512*block.expansion*widen_factor), int(512*block.expansion*widen_factor))
        self.linear2 = nn.Linear(int(512*block.expansion*widen_factor), num_classes)
...
# def resnet9(num_classes=10, widen_factor=1):
#     return ResNet(BasicBlock, [1, 1, 1, 1], num_classes, widen_factor=widen_factor)

def resnet18_mlp(num_classes=10, widen_factor=1, dropout=None):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, widen_factor=widen_factor, dropout=dropout)
